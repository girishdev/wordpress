...
function ffl_add_footer($content){
	...
	$footer_output .= '<span class="dashicons dashicons-facebook"></span> <b>Find me On: <a style="color:'.$ffl_options['link_color'].'" target="_blank" href="'.$ffl_options['facebook_url'].'">Facebook</a></b>';
	$footer_output .= '</div>';
